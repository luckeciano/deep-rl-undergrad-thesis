...
Figure \ref{fig:hlmrewardcurve} shows the reward curve for HLM+RNR model. 
...
Figure \ref{fig:hlmrnrmotionsequence} shows the motion sequence for HLM+RNR model.
...
\end{figure}
 ...
 \begin{figure}[!htbp]
 	\centering
 	\includegraphics[ width=1.1\textwidth]{Cap6/hlmretsess2}
 ...
 \begin{figure}[!htbp]
 	\centering
 	\includegraphics[ scale=1.0]{Cap6/hlmretsess2motseq}
