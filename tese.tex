...
\examiner{Prof. Dr.}{Marcos R. O. de A. Máximo}{}{ITA}
...
\chapter{Reinforcement Learning}\label{ch:reinforcementlearning}
\input{Cap4/cap4}
...
% Apendices
\appendix
\chapter{Hyperparameters}\label{ap:hyperparameters} %opcional
...
\FRDitadata{November 19th, 2018}
\FRDitadocnro{DCTA/ITA/TC-057/2018} %(o número de registro você solicita a biblioteca)
...
\FRDitapalavrasresult{Aprendizagem (inteligência artificial); Dinâmica de Robôs; Redes neurais; Robótica; Computação.}
